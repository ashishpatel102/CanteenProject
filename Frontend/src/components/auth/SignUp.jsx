      ...
      <div id="auth-container" className="p-4 w-100 text-dark" style={{ maxWidth: "400px", borderRadius: "15px" }}>
        ...
        <form onSubmit={handleSignup}>
          <div className="mb-3 input-group">
            <input type="text" name="username" value={(formData.username).toLowerCase().replace(' ', '_').trim()} placeholder="Username" className="form-control" onChange={handleChange} required />
          </div>
          <div className="mb-3 input-group">
